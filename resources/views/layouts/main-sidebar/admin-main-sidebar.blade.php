    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="students-menu" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a
                        href="{{ route('dashboard.promotions.index') }}">{{ trans('main_trans.Students_Promotions') }}</a>
                </li>
        ...
        <li>
            ...
            <ul id="Teachers-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a
                        href="{{ route('dashboard.teachers.index') }}">{{ trans('main_trans.List_Teachers') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('dashboard.online_classes.index') }}">الاتصال مباشر مع زوم</a>
                </li>
                <li> <a href="{{ route('dashboard.indirect.create') }}">الاتصال الغير مباشر مع زوم</a>
                </li>
