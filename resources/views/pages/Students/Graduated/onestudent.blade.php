...
<div class="modal fade" id="Graduated" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.graduated.edit',$promotion->student->id)}}" >
