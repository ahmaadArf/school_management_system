                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="profile-02" role="tabpanel"
                                    ...
                                    <div class="card card-statistics">
                                        <div class="card-body">
                                            <form method="post" action="{{route('dashboard.students.Upload_attachment')}}" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div class="col-md-3">
                                        ...
                                        <table class="table center-aligned-table mb-0 table table-hover"
                                            ...
                                            <tr class="table-secondary">
                                                <th scope="col">#</th>
                                                <th scope="col">{{trans('Students_trans.Image')}}</th>
                                            ...
                                            @foreach($Student->images as $attachment)
                                                <tr style='text-align:center;vertical-align:middle'>
                                                    ...
                                                    <td><img width="80" src="{{ asset('attachments/students/'.$Student->name.'/'.$attachment->filename) }}" alt=""></td>
                                                    <td>{{$attachment->filename}}</td>
                                                    <td>{{$attachment->created_at->diffForHumans()}}</td>
                                                    <td colspan="2">
                                                        <a class="btn btn-outline-info btn-sm"
                                                           href="{{route('dashboard.students.Download_attachment',['studentsname' => $attachment->imageable->name, 'filename' => $attachment->filename] )}}"
