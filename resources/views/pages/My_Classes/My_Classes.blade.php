    ...
    <div class="col-xl-12 mb-30">
        <div class="card card-statistics h-100">
            ...
            <button type="button" class="button x-small" id="btn_delete_all">
                ...
                <form action="{{ route('dashboard.classrooms.filter') }}" method="POST">
                    {{ csrf_field() }}
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <thead>
                            <tr>
                                <th><input value="0" name="select_all" id="example-select-all" type="checkbox" onclick="CheckAll('box1', this)" /></th>
                                <th>#</th>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <input id="Name" type="text" name="Name"
                                                                class="form-control" value="{{ $classroom->getTranslation('Name_Class', 'ar') }}" >
                                                        ...
                                                        <div class="col">
                                                            <label for="Name_en"
                                                                ...
                                                                :</label>
                                                            <input type="text" class="form-control" value="{{ $classroom->getTranslation('Name_Class', 'en') }}"
                                                                name="Name_en" >
                                                        </div>
                                                    </div>
                                                    <br><br>
...
<div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('dashboard.classrooms.delete_all') }}" method="POST">
                {{ csrf_field() }}
                <div class="modal-body">
