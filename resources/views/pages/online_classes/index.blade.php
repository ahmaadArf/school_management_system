            ...
            <div class="card card-statistics h-100">
               ...
               @endif
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('dashboard.online_classes.create')}}" class="btn btn-success" role="button" aria-pressed="true">اضافة حصة اونلاين جديدة</a>
                                <a class="btn btn-warning" href="{{route('dashboard.indirect.create')}}">اضافة حصة اوفلاين جديدة</a>
