            ...
            <div class="card card-statistics h-100">
                ...
                @endif
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('dashboard.quizzes.create')}}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($quizzes as $quizze)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('dashboard.quizzes.edit',$quizze->id)}}"
                                            ...
                                            <div class="modal fade" id="delete_exam{{$quizze->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('dashboard.quizzes.destroy','test')}}" method="post">
                                                        {{method_field('delete')}}
                                                        {{csrf_field()}}
